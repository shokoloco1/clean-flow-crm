      ...
      <main className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <p>
              By accessing and using Pulcrix ("the Service"), you agree to be bound by these Terms
              of Service. If you do not agree with any part of these terms, you may not access the
              Service.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>Pulcrix is a management platform for cleaning businesses that enables:</p>
          ...
          <section className="space-y-4">
            ...
            <p>
              Subscription plans are billed monthly or annually as you choose. All payments are
              non-refundable except as set out in our refund policy. Prices may change with 30 days'
              prior notice.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              The Service and its original content, features and functionality are the property of
              Pulcrix and are protected by intellectual property laws. You retain all rights to your
              data and content.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              In no event shall Pulcrix be liable for indirect, incidental, special, consequential
              or punitive damages, including loss of profits, data, use or other intangible loss.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              significant changes by email or by posting a notice on the Service.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              <a href="mailto:legal@pulcrix.com" className="ml-1 text-primary hover:underline">
                legal@pulcrix.com
              </a>
            </p>
          </section>
