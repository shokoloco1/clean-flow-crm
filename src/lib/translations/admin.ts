...
export const adminTranslations = {
  en: {
    ...
    generate_report: "Generate Pay Report",
    ...
    hours: "Hours",
    jobs_count: "Jobs",
    pay_estimate: "Pay Estimate",
    all_staff: "All Staff",
    this_week: "This Week",
    last_week: "Last Week",
    custom_range: "Custom Range",
    active_timers: "Active Timers",
    stale_entries_alert: "Stale entries detected — staff may have forgotten to clock out",
    ...
    approved: "Approved",
    exported: "Exported",
    no_reports: "No pay reports generated yet",
  ...
  es: {
    ...
    pay_reports: "Reportes de Pago",
    hourly_rate: "Tarifa por Hora",
    generate_report: "Generar Reporte de Pago",
    ...
    hours: "Horas",
    jobs_count: "Trabajos",
    pay_estimate: "Pago Estimado",
    all_staff: "Todo el Personal",
    this_week: "Esta Semana",
    last_week: "Semana Pasada",
    custom_range: "Rango Personalizado",
    active_timers: "Temporizadores Activos",
    stale_entries_alert: "Entradas antiguas detectadas — el personal pudo olvidar registrar salida",
    force_clock_out: "Forzar Salida",
    set_rate: "Establecer Tarifa",
    effective_from: "Vigente Desde",
    report_period: "Periodo del Reporte",
    draft: "Borrador",
    approved: "Aprobado",
    exported: "Exportado",
    no_reports: "No hay reportes de pago generados",
    no_time_entries: "Sin entradas de tiempo para este periodo",
    per_hour: "/hora",
