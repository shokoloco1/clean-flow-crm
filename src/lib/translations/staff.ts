...
export const staffTranslations = {
  en: {
    ...
    next_week: "Next Week",
    clock_out_confirm: "You worked {{hours}}h {{minutes}}m on this job. Clock out?",
    already_clocked_in: "You are already clocked in to another job. Clock out first.",
    no_active_timer: "No active timer",
    staff_notes_label: "Staff Notes",
    break_minutes: "Break (minutes)",
    no_entries_this_week: "No time entries this week",
    stale_timer_warning: "Timer exceeded 12h — please clock out or contact admin",
  },
  es: {
    // Dashboard
    ...
    continue_workflow: "Continuar Trabajo",
    ...
    timer: "Temporizador",
    add_break: "Agregar Tiempo de Descanso",
    ...
    clock_out_confirm: "Trabajaste {{hours}}h {{minutes}}m en este trabajo. ¿Registrar salida?",
    already_clocked_in: "Ya tienes entrada registrada en otro trabajo. Registra salida primero.",
    no_active_timer: "Sin temporizador activo",
    staff_notes_label: "Notas del Personal",
    break_minutes: "Descanso (minutos)",
    no_entries_this_week: "Sin entradas de tiempo esta semana",
    stale_timer_warning: "Temporizador excede 12h — registra salida o contacta al admin",
  },
} as const;
