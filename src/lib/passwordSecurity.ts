...
export const passwordSchema = z
  ...
  .refine((password) => /[a-z]/.test(password), "Must include at least one lowercase letter")
  .refine((password) => /[A-Z]/.test(password), "Must include at least one uppercase letter")
  .refine((password) => /[0-9]/.test(password), "Must include at least one number")
  .refine(
  ...
  .refine((password) => !hasWeakPattern(password), "Password contains a predictable pattern");
